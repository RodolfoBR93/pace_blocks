...
Future<void> populateInitialWorkoutTypesWithLocaleIds(
  Map<String, int> localeIdMap,
) async {
  try {
    ...
    types.addAll([
      ...
      WorkoutType(
        name: 'Very Strong Run',
        code: 'CMF',
        locale: localeIdMap['en']!,
      ),
    ...
    types.addAll([
      ...
      WorkoutType(
        name: 'Leichtes Laufen',
        code: 'CL',
        locale: localeIdMap['de']!,
      ),
      WorkoutType(
        name: 'Moderat Laufen',
        code: 'CM',
      ...
      WorkoutType(
        name: 'Schnelles Laufen',
        code: 'CF',
        locale: localeIdMap['de']!,
      ),
      WorkoutType(
        name: 'Sehr Schnelles Laufen',
        code: 'CMF',
        locale: localeIdMap['de']!,
      ),
